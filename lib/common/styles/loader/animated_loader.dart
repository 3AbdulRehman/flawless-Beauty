    ...
    return  Center(
      child: Column(
        ...
        children: [
          ...
          child: OutlinedButton(onPressed: onActionPressed,style: OutlinedButton.styleFrom(backgroundColor: TColors.dark),
              child: Text(actionText!,style: Theme.of(context).textTheme.bodyMedium!.apply(color: TColors.white),)) ,
          ) : const SizedBox()
        ],
      ),
    );
