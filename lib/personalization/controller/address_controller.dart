...
class AddressController extends GetxController{
  ...
  Future selectAddress(AddressModel newSelectedAddress)async{
    try{
      ...
      Get.defaultDialog(
        ...
        content: const CircularProgressIndicator(color: TColors.primary,)
      );
      // // clear
  ...
  Future addNewAddresses() async{
   try{
     TFullScreenLoader.openLoadingDialog('Starting Address....', TImage.docerAnimation);
     ...
     TLoader.successSnackBar(title: 'Congratulation',message: 'Your address has beeen Saved Successfully.');
